...
- Installation using setup tools
- Installation using python pip module
- Steps for setting Reference genome

## Libraries

CNVpytor is written is python and in works on both python 2 and 3. Please install python before proceed with the installation steps. 
